...
public class JSONUtil {
     ...
     */
    public static String serialize(Object object, int maxDeep) throws JSONException {
        JSONWriter writer = new JSONWriter();

        return writer.write(object, maxDeep);
    }
    ...
    public static String serialize(Object object, Collection<Pattern> excludeProperties, Collection<Pattern> includeProperties,
        boolean ignoreHierarchy, int maxDeep) throws JSONException {
        JSONWriter writer = new JSONWriter();
        writer.setIgnoreHierarchy(ignoreHierarchy);
        return writer.write(object, excludeProperties, includeProperties, maxDeep);
    }
    ...
    public static String serialize(Object object, Collection<Pattern> excludeProperties,
    		Collection<Pattern> includeProperties, boolean ignoreHierarchy, boolean enumAsBean, int maxDeep) throws JSONException {
        JSONWriter writer = new JSONWriter();
        writer.setIgnoreHierarchy(ignoreHierarchy);
     ...
     * @throws JSONException
     */
    public static void serialize(Writer writer, Object object, int maxDeep) throws IOException,
        JSONException {
        writer.write(serialize(object, maxDeep));
    }
    ...
    public static void serialize(Writer writer, Object object,
    		 Collection<Pattern> excludeProperties, Collection<Pattern> includeProperties, int maxDeep) throws IOException, JSONException {
    	 writer.write(serialize(object, excludeProperties, includeProperties, true, maxDeep));
    }
